    ...
    return (
      <div id={containerStyle} className="container">
        ...
        <Row>
          <Col sm={6}>
            <Panel>
              <p>Reviews will all be published on this page. If you're looking for a piece from a particular month just click on that month. Otherwise, have a good scroll through!</p>
              <ul>
                <li><Link to="reviews/03-2017">March 17</Link></li>
              </ul>
            </Panel>
          </Col>
          <Col sm={6}>
